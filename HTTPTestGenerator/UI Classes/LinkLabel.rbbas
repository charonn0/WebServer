...
Inherits Label
	...
	#tag Event
		Sub MouseUp(X As Integer, Y As Integer)
		  #pragma Unused X
		  #pragma Unused Y
		  'If (Me.Left < Me.TrueWindow.MouseX) And (Me.TrueWindow.MouseX < Me.Left + Me.Width) And (Me.Top < Me.TrueWindow.Mousey) And (Me.TrueWindow.Mousey < Me.Top + Me.height) Then
